## stag_ros (noetic) - 0.3.9-3

The packages in the `stag_ros` repository were released into the `noetic` distro by running `/usr/bin/bloom-release stag_ros --rosdistro noetic` on `Mon, 03 May 2021 18:28:51 -0000`
...
## stag_ros (noetic) - 0.3.9-2

The packages in the `stag_ros` repository were released into the `noetic` distro by running `/usr/bin/bloom-release stag_ros --rosdistro noetic` on `Mon, 03 May 2021 18:23:01 -0000`
...
## stag_ros (noetic) - 0.3.9-1

The packages in the `stag_ros` repository were released into the `noetic` distro by running `/usr/bin/bloom-release stag_ros --rosdistro noetic` on `Mon, 03 May 2021 18:06:35 -0000`
...
## stag_ros (noetic) - 0.3.8-1

The packages in the `stag_ros` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic --track noetic stag_ros` on `Fri, 19 Mar 2021 15:54:55 -0000`
...
## stag_ros (kinetic) - 0.1.1-4

The packages in the `stag_ros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic stag_ros --edit` on `Tue, 15 Dec 2020 01:11:34 -0000`
...
## stag_ros (kinetic) - 0.1.1-3

The packages in the `stag_ros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic stag_ros --edit` on `Mon, 14 Dec 2020 21:22:31 -0000`
...
## stag_ros (kinetic) - 0.1.1-2

The packages in the `stag_ros` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic stag_ros --edit` on `Mon, 14 Dec 2020 21:14:41 -0000`
